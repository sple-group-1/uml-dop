...
public abstract class WishlsitServiceComponent implements WishlistService{
	protected RepositoryUtil<Wishlist> Repository;

    public WishlsitServiceComponent(){
        this.Repository = new RepositoryUtil<Wishlist>(OnlineTicketing.wishlist.core.WishlsitComponent.class);
    }	
