...
public abstract class WishlsitResourceDecorator extends WishlsitResourceComponent{
	protected WishlsitResourceComponent record;

    public WishlsitResourceDecorator(WishlsitResourceComponent record) {
        this.record = record;
    }
